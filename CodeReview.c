...
7. returning errorString may lead to unwanted behavior or data. errorString is local to the function scope and the pointer may no longer point to intended data
when GetErrorString returns from function stack. Work arounds include passing in an array or making errorString array Static. Since errorString is not static, 
it should be explicitly initialized = {0}
*/
